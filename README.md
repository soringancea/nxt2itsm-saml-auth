...
```
The solution is now installed in /home/nexthink/node_modules/nxt2itsm-saml. Go to the configuration section for the next steps.
...
```
cd /home/nexthink/node_modules/nxt2itsm-saml/ssl/
sudo rm -f *.pem
...
Once the configuration is done, start pm2 and then the app.js from the /home/nexthink/node_modules/nxt2itsm-saml folder with the following commands:
```
cd /home/nexthink/node_modules/nxt2itsm-saml
